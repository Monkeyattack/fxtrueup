...
app.post('/api/accounts', (req, res) => {
  ...
  // TODO: When MetaApi integration is enabled:
  // 1. Create provisioning profile for the account
  // 2. Deploy account to MetaApi using METAAPI_TOKEN
  // 3. Store MetaApi account ID in database
...
app.get('/api/accounts/:id/metrics', async (req, res) => {
  ...
  res.json({
    ...
    marginLevel: 100 + Math.random() * 400,
