...
app.get('/api/auth/google/login', (req, res) => {  const clientId = process.env.GOOGLE_CLIENT_ID || 'YOUR_GOOGLE_CLIENT_ID';  const redirectUri = 'https://fxtrueup.com/api/auth/google/callback';  const authUrl = ;  res.redirect(authUrl);});
// });
